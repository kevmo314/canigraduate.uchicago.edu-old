      ...
      return {
        ...
        link: function (originalScope, element, attrs, modelCtrl) {
          ...
          function getHeaderText() {
            if (is_empty(modelCtrl.$modelValue)) return scope.header = attrs.msHeader || 'all of them!';
...
angular.module('multiselect.tpl.html', [])
  ...
  .run(['$templateCache', function($templateCache) {
    $templateCache.put('multiselect.tpl.html',
      ...
      "<div class=\"btn-group\">\n" +
      "  <button type=\"button\" class=\"btn btn-xs btn-default dropdown-toggle\" ng-click=\"toggleSelect()\" ng-disabled=\"disabled\" ng-class=\"{'error': !valid()}\">\n" +
      ...
      "    </li>\n" +
      "    <li class=\"pointer\" ng-repeat=\"i in items | filter:searchText\">\n" +
