				...
				<nav class="navbar">
					...
					<div class="collapse navbar-collapse" collapse="!isNavbarCollapsed">
						...
						<div class="nav navbar-nav navbar-right">
							...
							<button ng-click="dropout()" class="pointer btn btn-warning navbar-btn"
								tooltip="New! Tired of trying to graduate? Drop out!" tooltip-is-open="true" tooltip-placement="bottom"><span class="glyphicon glyphicon-thumbs-up"></span> <span class="hidden-sm hidden-md">Drop Out</span></button>&nbsp;
